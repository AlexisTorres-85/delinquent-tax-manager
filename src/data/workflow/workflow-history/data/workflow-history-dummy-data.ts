...
export const WORKFLOW_HISTORY_DUMMY_DATA: ParcelWorkflowHistory[] = [
  {
    ...
    entries: [
      ...
      { id: 'wh-0019', workflowId: 'WF-2019-042', dateTime: '01/10/2019 09:00', status: 'Delinquent', stage: 'Initial Delinquency', actionTaken: 'Case Opened', performedBy: 'J. Martinez', documentCount: 1, isActive: false },
      { id: 'wh-0020', workflowId: 'WF-2019-042', dateTime: '03/05/2019 10:30', status: 'Delinquent', stage: 'Early Notice Issued', actionTaken: 'Notice Sent', performedBy: 'J. Martinez', documentCount: 2, isActive: false },
      { id: 'wh-0021', workflowId: 'WF-2019-042', dateTime: '06/20/2019 14:15', status: 'Delinquent', stage: 'Final Notice Issued', actionTaken: 'Notice Sent', performedBy: 'S. Kowalski', documentCount: 3, isActive: false },
      { id: 'wh-0022', workflowId: 'WF-2019-042', dateTime: '09/01/2019 11:00', status: 'Payment Plan', stage: 'In Payment Plan', actionTaken: 'Status Changed', performedBy: 'R. Patel', documentCount: 2, notes: 'Owner agreed to 6-month payment plan.', isActive: false },
      { id: 'wh-0023', workflowId: 'WF-2019-042', dateTime: '11/15/2019 09:45', status: 'Complete', stage: 'Paid in Full', actionTaken: 'Case Closed', performedBy: 'R. Patel', documentCount: 1, notes: 'Final payment received. Account cleared.', isActive: true },
      // ── WF-2021-115 (Tax Years 2020–2021) ────────────────────────────────
      { id: 'wh-0024', workflowId: 'WF-2021-115', dateTime: '02/01/2020 08:30', status: 'Delinquent', stage: 'Initial Delinquency', actionTaken: 'Case Opened', performedBy: 'T. Williams', documentCount: 1, isActive: false },
      { id: 'wh-0025', workflowId: 'WF-2021-115', dateTime: '04/14/2020 11:00', status: 'Delinquent', stage: 'Early Notice Issued', actionTaken: 'Notice Sent', performedBy: 'T. Williams', documentCount: 2, isActive: false },
      { id: 'wh-0026', workflowId: 'WF-2021-115', dateTime: '08/10/2020 14:00', status: 'Delinquent', stage: 'Final Notice Issued', actionTaken: 'Notice Sent', performedBy: 'M. Johnson', documentCount: 3, isActive: false },
      { id: 'wh-0027', workflowId: 'WF-2021-115', dateTime: '11/20/2020 09:30', status: 'Early Enforcement', stage: 'Title Search', actionTaken: 'Title Search Completed', performedBy: 'A. Chen', documentCount: 5, isActive: false },
      { id: 'wh-0028', workflowId: 'WF-2021-115', dateTime: '03/08/2021 13:15', status: 'Early Enforcement', stage: 'Owner/Occupant Notification', actionTaken: 'Notice Sent', performedBy: 'A. Chen', documentCount: 3, notes: 'Certified mail confirmed received.', isActive: false },
      { id: 'wh-0029', workflowId: 'WF-2021-115', dateTime: '06/30/2021 10:00', status: 'Financial Processing', stage: 'Finance Journal Entry', actionTaken: 'Stage Advanced', performedBy: 'D. Brown', documentCount: 2, isActive: false },
      { id: 'wh-0030', workflowId: 'WF-2021-115', dateTime: '09/10/2021 11:30', status: 'Complete', stage: 'Move to Treasurer', actionTaken: 'Case Closed', performedBy: 'D. Brown', documentCount: 4, notes: 'Proceeds disbursed. Transferred to county treasurer.', isActive: true },
